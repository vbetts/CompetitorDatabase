...
from .models import Competitor, Feature, Category, GlobalMarket, VerticalMarket, ResourceCategory
...
class SelectCompetitor(forms.Form):
    ...
    selection = forms.ModelMultipleChoiceField(queryset=Competitor.objects.all()
                                               .order_by('name'),
...
class VerticalMarketForm(forms.Form):
    ...
    selection = forms.ModelMultipleChoiceField(queryset=Competitor.objects.distinct()
                                               .filter(verticalMarket__isnull=False)
                                               .order_by('name'),
                                               label="Filter by Company",
                                               required=False,
                                               widget=forms.SelectMultiple(attrs={'class': "form-control",
    ...
    verticalMarketSelect = forms.ModelMultipleChoiceField(queryset=VerticalMarket.objects.all()
                                                          .order_by('name'),
...
class GlobalMarketForm(forms.Form):
    ...
    selection = forms.ModelMultipleChoiceField(queryset=Competitor.objects.distinct()
                                               .filter(globalMarket__isnull=False)
                                               .order_by('name'),
                                               label="Filter by Company",
                                               required=False,
                                               widget=forms.SelectMultiple(attrs={'class': "form-control",
    ...
    graphType = forms.ChoiceField(choices=GRAPH_CHOICES,
                                  ...
                                  widget=forms.Select(attrs={'class': "form-control",
                                                             'id': "graphType", }))
    globalMarketSelect = forms.ModelMultipleChoiceField(queryset=GlobalMarket.objects.all()
                                                        .order_by('name'),
                                                        label="Filter by Market",
                                                        required=False,
                                                        widget=forms.SelectMultiple(attrs={'class': "form-control",
...
class CategoriesForm(forms.Form):
    selection = forms.ModelMultipleChoiceField(queryset=Competitor.objects.distinct().filter(categories__isnull=False)
                                               .order_by('name'),
    ...
    categorySelect = forms.ModelMultipleChoiceField(queryset=Category.objects.all()
                                                    .order_by('name'),
...
class PrintPageForm(forms.Form):
    selection = forms.ModelChoiceField(queryset=Competitor.objects.all()
                                       .order_by('name'),
                                       label="Select a competitor to generate a data sheet",
                                       required=True,
                                       widget=forms.Select(attrs={'class': "form-control",
                                                                  'required': "true",
                                                                  'style': "width: 250px", }))
    showCategories = forms.BooleanField(label="Show Competitor Web Filtering Categories",
                                        required=False, )
    showPartners = forms.BooleanField(label="Show Competitor Partnerships",
                                      required=False, )
...
class CompetitorDocsForm(forms.Form):
    selection = forms.ModelMultipleChoiceField(queryset=Competitor.objects
                                               .filter(additionalinfo__isnull=False)
                                               .distinct(),
...
class SalesDocsForm(forms.Form):
    selection = forms.ModelMultipleChoiceField(queryset=ResourceCategory.objects.all()
                                               .order_by('name'),
